...
public class WikiSqlToCsvConverter {
    ...
    private static void convert(String folder, String filePrefix) throws FileNotFoundException {
        convert(new File(folder + "\\" + filePrefix + ".sql"), new File(folder + "\\" + filePrefix + ".csv"));
    }
