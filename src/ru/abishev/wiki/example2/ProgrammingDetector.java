//package ru.abishev.wiki.example2.example1;
//
...
//
//    public ProgrammingDetector(File anchorsFile) {
...
//        final ProgrammingDetector detector = new ProgrammingDetector(new File("./data/fprog_anchors.csv"));
//
